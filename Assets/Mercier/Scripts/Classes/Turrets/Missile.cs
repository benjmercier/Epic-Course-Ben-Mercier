...
namespace Mercier.Scripts.Classes.Turrets
{
    ...
    public class Missile : MonoBehaviour
    {
        ...
        [SerializeField]
        private float _launchSpeed = 1f; //launch speed of the rocket
        [SerializeField]
        private float _power = 10f; //power of the rocket
        [SerializeField] //fuse delay of the rocket
        private float _fuseDelay = 0.25f;
        ...
        private MissileLauncher_FSM.MissileType _missileType;
        ...
        void FixedUpdate()
        {
            ...
            {
                if (_missileType == MissileLauncher_FSM.MissileType.Normal) //checking for normal missile 
                {
                ...
                else if (_missileType == MissileLauncher_FSM.MissileType.Homing) //if missle is homing
                {
                    if (_target == null) //checking if the target is null
                    {
                        _missileType = MissileLauncher_FSM.MissileType.Normal; //assign back to normal
                        return;
                    }
        ...
        /// </summary>
        public void AssignMissileRules(MissileLauncher_FSM.MissileType missileType, Transform target, float launchSpeed, float power, float fuseDelay, float destroyTimer)
        {
